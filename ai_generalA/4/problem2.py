...
Original file is located at
    https://colab.research.google.com/drive/1oNELboAaV9TyH661ognIvdHcI7eot095
"""
...
class RNNEncDec(torch.nn.Module):
  ...
  def forward(self, x):
    ...
    print(self.decout(h).shape, y.shape)
...
input = torch.randn(5, 128)#(seq_len, batch, input_size)
